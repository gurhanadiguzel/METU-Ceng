...
public class Evaluation {
    ...
    private static String user = "e2448025"; // TODO: Your userName
    private static String password = "4dOb5AHa1l71J48S"; //  TODO: Your password
    private static String host = "momcorp.ceng.metu.edu.tr"; // host name
    private static String database = "db2448025"; // TODO: Your database name
    ...
    public static void main(String[] args) {
       ...
       String foodrecdbDirectory = "/Downloads/PA1/ceng/ceng/ceng351/foodrecdb" + System.getProperty("file.separator") +
       ...
       try {
            ...
            try {
                ...
                printLine("Q3.1: Exception occurred: \n\n" + e.toString(),bufferedWriter);
            }
           ...
           /***********************************************************/
            ...
            /***********************************************************/
            addDivider(bufferedWriter);
            addInputTitle("Find the cuisine with the highest average rating of menu items belonging to that cuisine",bufferedWriter);
            try {
