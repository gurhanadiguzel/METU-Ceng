...
#	2448025
#
#	I added the ISUBQ instruction to the HCL. With the ISUBQ instruction, 
#	if my ValB value is negative, my ISUBQ instruction do the substraction like 
#	(ValC - ValB)  = ValB. If my ValB is positive than my ISUBQ instruction do 
#	the addition like (ValB + ValC = ValB). In this way, I can take the absolute value 
#	of my negative and positive numbers without checking its value in function. This way
#	I do not have to do different operations for positive and negative numbers.
#	And I get rid of from the Jump functions for different operations for positive and 
#	negative numbers.
#
####################################################################
...
word alufun = [
	E_icode == IOPQ : E_ifun;
	(E_icode == IISUBQ && E_valB < 0 && E_valC>=0): ALUSUB;
	1 : ALUADD;
];

## Should the condition codes be updated?
bool set_cc = (E_icode == IOPQ ||  E_icode == IISUBQ) && 
