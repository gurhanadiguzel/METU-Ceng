...
void initShaders()
{
    ...
    createVS(gProgram[3], "vert1.glsl");
    createFS(gProgram[3], "frag1.glsl");
...
void display()
{
    ...
    glm::mat4 T = glm::translate(glm::mat4(1.f), glm::vec3(-8.f, -8.f, -10.f));
    ...
    T = glm::translate(glm::mat4(1.f), glm::vec3(2.f, -4.f, -10.f));
    R = glm::rotate(glm::mat4(1.f), glm::radians(-angle), glm::vec3(0, 1, 0));
    modelMat = T * R;
    modelMatInv = glm::transpose(glm::inverse(modelMat));
    ...
    renderText("Moves:0 Score: 0", 0, 0, 1, glm::vec3(0, 1, 1));
