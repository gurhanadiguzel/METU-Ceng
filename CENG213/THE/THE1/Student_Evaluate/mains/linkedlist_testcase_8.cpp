...
/*
 * Case 8 : Default constructor; various inserts; insertAsEveryKthNode; getSize and isEmpty; print.
 */
int main() {
    ...
    std::cout << "-> Inserting nodes with data 60 as the every 2nd node of the list." << std::endl;

    llist.insertAsEveryKthNode(60, 2);
