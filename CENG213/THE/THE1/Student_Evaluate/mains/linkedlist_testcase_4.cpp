...
/*
 * Case 4 : Default constructor; insertAtTheFront on empty linked list; print.
 */
int main() {
    ...
    std::cout << "-> Inserting a node with data 64 to the front of the list." << std::endl;

    llist.insertAtTheFront(64);
