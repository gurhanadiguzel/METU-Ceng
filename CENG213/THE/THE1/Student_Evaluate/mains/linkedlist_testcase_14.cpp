...
/*
 * Case 14 : Default constructor; various inserts; various utility functions; print.
 */
int main() {
    ...
    std::cout << "data of first data node is " << llist.getFirstNode()->data << std::endl;
    std::cout << "data of last data node is " << llist.getLastNode()->data << std::endl;
